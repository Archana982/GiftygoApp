...
import com.example.giftygo.databinding.SizeItemBinding
...
class SizeAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.btnColorItem.text = list[position]


        holder.binding.btnColorItem.setOnClickListener {

            onClickSize.onClickSize(holder.binding.btnColorItem ,position)
        }
